...
/**
 * * Collision listener that allows the main character to collect pokeballs.**
 */
public class PickThePokeball implements CollisionListener {

    private MainCharacter mainCharacter;

    public PickThePokeball(MainCharacter mainCharacter) {
    ...
    public void collide(CollisionEvent e) {
        if (e.getOtherBody() == mainCharacter) {
            mainCharacter.incrementPokeballCount();
...
(etc collect the pokeballs when the body of the main character collides with the pokeball).
